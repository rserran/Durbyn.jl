...
function _plot_single_grouped(fc, key, actual_dict, show_fitted)
    ...
    p = Durbyn.plot(fc_obj, show_fitted=show_fitted)
...
function _plot_faceted(fc, selected_keys, n_cols, actual_dict, show_fitted)
    ...
    for key in selected_keys
        ...
        p = Durbyn.plot(fc_obj, show_fitted=false)
...
"""
function Durbyn.plot(res::Durbyn.Stats.MSTLResult; labels=nothing,
              col_range::Any="lightgray",
              main::Union{Nothing,String}=nothing,
              range_bars::Bool=true,
              kwargs...)
